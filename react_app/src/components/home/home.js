...
function Home() {
    ...
    <Section>
        ...
        <DivContent>
            ...
            <p> Partez à la découverte de l'histoire de la vie en visitant les galeries </p>
            <p> Nos galeries retrace l'histoire sur plus de 165 millions d'années au sein de ses différentes salles </p>
